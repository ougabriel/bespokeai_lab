...
PROTECTED_HASHES = {
    ...
    "/app/app/main.py": "79371ad0b84cac95563362219cdea39058e922da2f159adf52318fc8b72d601f",
    ...
    "/app/bin/simulate_rollout.py": "16e6cdb2ba674708d0fb66fff6d070752c563e58afe836b36e96f0bd47374355",
}
...
def release_contract() -> dict[str, object]:
    ...
    service = load_yaml(LAB_ROOT / "app-repo" / "services" / "aurora-gateway" / "service-catalog.yaml")[
        "service"
    ]
...
def stable_end_state() -> tuple[float, dict[str, bool]]:
    ...
    deployment_path = LAB_ROOT / "cluster" / "live" / "deployments" / "aurora-gateway.yaml"
    ...
    route_path = LAB_ROOT / "cluster" / "live" / "routes" / "aurora-gateway.yaml"
    ...
    mesh_path = LAB_ROOT / "cluster" / "live" / "mesh" / "aurora-gateway.yaml"
    ...
    telemetry_path = LAB_ROOT / "cluster" / "live" / "telemetry" / "aurora-gateway.yaml"
...
def main() -> None:
    ...
    try:
        ...
        release_metadata = load_yaml(LAB_ROOT / "app-repo" / "services" / "aurora-gateway" / "release.yaml")
        ...
        release_contract_manifest = load_section(
            LAB_ROOT / "app-repo" / "services" / "aurora-gateway" / "release-contract.yaml",
            "contract",
        )
        ...
        release_baton = load_section(
            LAB_ROOT / "app-repo" / "services" / "aurora-gateway" / "release-baton.yaml",
            "baton",
        )
        ...
        release_attestation = load_section(
            LAB_ROOT / "app-repo" / "services" / "aurora-gateway" / "release-attestation.yaml",
            "attestation",
        )
        ...
        application = load_section(gitops_root / "apps" / "aurora-gateway" / "application.yaml", "application")
        values = load_yaml(gitops_root / contract["prod_overlay"] / "values.yaml")
